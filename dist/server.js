...
const getChuckJoke = server.registerTool("get-chuck-joke", {
...
const getChuckJokeByCategory = server.registerTool("get-chuck-joke-by-category", {
...
const getChuckCategories = server.registerTool("get-chuck-categories", {
...
// Get Dad joke tool
const getDadJoke = server.registerTool("get-dad-joke", {
